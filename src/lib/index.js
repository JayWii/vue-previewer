    ...
    Vue.directive("preview", {
      bind: function(el) {
        let previewItem = {
          ...
          index: 0,
          src:
            "data:img/jpgbase64,iVBORw0KGgoAAAANSUhEUgAAAAEAAAABAQMAAAAl21bKAAAAA1BMVEXs7Oxc9QatAAAACklEQVQI12NgAAAAAgAB4iG8MwAAAABJRU5ErkJggg=="
        }
        LOGIC_EVENT_BUS.LOGIC_PREVIEW.list.push(previewItem)
        updateIndex(LOGIC_EVENT_BUS.LOGIC_PREVIEW.list)
        el.addEventListener("click", e => {
          e.stopPropagation()
          LOGIC_EVENT_BUS.LOGIC_PREVIEW.isTitleEnable =
            el.getAttribute("preview-title-enable") == "false" ? false : true
          LOGIC_EVENT_BUS.LOGIC_PREVIEW.isHorizontalNavEnable =
            el.getAttribute("preview-nav-enable") == "false" ? false : true
